  ...
  kinContainer.innerHTML = `
    <div style="display:flex;align-items:center;gap:.8rem;background:rgba(165,124,0,.07);border:1px solid var(--border-g);border-radius:8px;padding:.7rem 1rem;margin-bottom:1.1rem">
      ...
      <div style="flex:1">
        ...
        <audio id="${audioId}" src="https://drive.google.com/uc?export=download&id=1hOUbkDrKGOjs_VE1f83pBgkHlcG6lRIR" controls style="width:100%;height:32px;accent-color:var(--gold2)" preload="auto"></audio>
      </div>
    </div>
    ${TEXTO_PRECE}`;

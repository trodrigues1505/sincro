...
import { calcOraculo, gerarPoema, SELOS_NOMES, TONS_NOMES, POEMA_TOM, POEMA_SELO, SELOS_MAIAS } from './cartilha.js';
...
window.calcularTabelaGuia = function() {
  ...
  import('./cartilha.js').then(({ calcOraculo, calcGuia, SELOS_NOMES: SN, POEMA_TOM: PT, POEMA_SELO: PS, SELOS_MAIAS: SM }) => {
    import('./data.js').then(({ SELOS_NOMES, TONS_NOMES, POEMA_TOM, POEMA_SELO, SELOS_MAIAS }) => {
      ...
      const corClass = { 0:'red',1:'white',2:'blue',3:'yellow',4:'red',5:'white',6:'blue',7:'yellow',8:'red',9:'white',10:'blue',11:'yellow',12:'red',13:'white',14:'blue',15:'yellow',16:'red',17:'white',18:'blue',19:'yellow' }[seloIdx]||'white';
      ...
      linhas.innerHTML = [
        row('Kin', `${kinNum} · Kin ${kinNum} de 260`,'var(--gold2)'),
